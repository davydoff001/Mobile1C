...
Функция ПолучитьНаСервере()
	...
	Если Объект.ОффЛайн Тогда
		тзРасписание = ПроцедурыОбщегоНазначения.ПолучитьОффЛайнРасписание(Объект.Направление,Объект.ПоказыватьНеОтправленые);
		Объект.Расписание.Загрузить(тзРасписание);
