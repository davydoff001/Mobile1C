...
Процедура ЗаполнитьКонтакты(ДанныеКонтакта)
	#Если МобильноеПриложениеКлиент Тогда
		...
		РеквизитыКонтактов.Добавить("Имя");
		РеквизитыКонтактов.Добавить("Отчество");
		РеквизитыКонтактов.Добавить("Прозвище");
		РеквизитыКонтактов.Добавить("Организация");
		РеквизитыКонтактов.Добавить("Отдел");
		РеквизитыКонтактов.Добавить("Должность");
		РеквизитыКонтактов.Добавить("Фамилия");
		РеквизитыКонтактов.Добавить("Заметка");
		...
		ДанныеКонтакта.АдресаЭлектроннойПочты = ПолучитьМассивДанных("АдресПочты","Строка",ТипАдресаЭлектроннойПочтыДанныхКонтакта);
	#КонецЕсли
КонецПроцедуры
